...
const LeftNav: React.FC<LeftNavProps> = ({
  ...
  return (
    <div className="w-64 min-h-full flex flex-col border-r border-primary bg-secondary">
      {/* Logo */}
      <div className="px-6 py-8 flex items-center justify-center border-b border-primary">
        <div className="w-32 h-32 flex items-center justify-center">
          <img src="/raccoon250px.png" alt="DealerScope" className="w-full h-full object-contain" />
        </div>
      </div>
